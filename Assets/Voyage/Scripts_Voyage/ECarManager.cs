...
public class ECarManager : MonoBehaviour
{
    [HideInInspector]
    public static ECarManager Instance { get; private set; } //for singleton

    public GameObject ECarPrefab; //{get;set;}guest gameobject to be instantiated
    ...
    private void AdmitGuest()
    {
        ...
        GameObject guest = Instantiate(ECarPrefab, position, Quaternion.identity); //adding our gameobject to scene
