...
public class FinalChair : Conveyance
{
    ...
    private List<Vector3> _RotationP = new List<Vector3>();
    ...
    public override void SetDestination()
    {
        ...
        for (int i = 0; i < Cars.transform.childCount; i++)
        {
            ...
            _positions.Add(InvisibleCars.transform.GetChild(i).transform);
    ...
    private void Update()
    {
        ...
        for (int i = 0; i < Cars.transform.childCount; i++)
        {
            ...
            {
                float carDirection = _positions[_cars[car]].position.y - car.transform.position.y;
            ...
            else
            {
                ...
                if (Vector3.Distance(UnloadPosition,guest.transform.position) < 8f)
                {
                    //unload guest
                    _carRiders[car] = null;
