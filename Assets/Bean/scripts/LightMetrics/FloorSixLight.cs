...
public class FloorSixLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorSixCount > floorTwoCount & floorSixCount > floorThreeCount & floorSixCount > floorFourCount & floorSixCount > floorFiveCount & floorSixCount > floorOneCount & floorSixCount > floorSevenCount & floorSixCount > floorEightCount)
        {
            LightOn();
        }
        else
