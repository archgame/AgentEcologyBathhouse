...
public class FloorEightLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorEightCount > floorTwoCount & floorEightCount > floorThreeCount & floorEightCount > floorFourCount & floorEightCount > floorFiveCount & floorEightCount > floorSixCount & floorEightCount > floorSevenCount & floorEightCount > floorOneCount)
        {
            LightOn();
        }
        else
