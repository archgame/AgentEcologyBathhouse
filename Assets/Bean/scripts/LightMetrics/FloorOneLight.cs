...
public class FloorOneLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorOneCount> floorTwoCount & floorOneCount>floorThreeCount & floorOneCount >floorFourCount & floorOneCount>floorFiveCount &floorOneCount > floorSixCount & floorOneCount> floorSevenCount& floorOneCount > floorEightCount)
        {
            LightOn();
        }
        else
