...
public class FloorSevenLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorSevenCount > floorTwoCount & floorSevenCount > floorThreeCount & floorSevenCount > floorFourCount & floorSevenCount > floorFiveCount & floorSevenCount > floorSixCount & floorSevenCount > floorOneCount & floorSevenCount > floorEightCount)
        {
            LightOn();
        }
        else
