...
public class FloorFourLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorFourCount > floorTwoCount & floorFourCount > floorThreeCount & floorFourCount > floorOneCount & floorFourCount > floorFiveCount & floorFourCount > floorSixCount & floorFourCount > floorSevenCount & floorFourCount > floorEightCount)
        {
            LightOn();
        }
        else
