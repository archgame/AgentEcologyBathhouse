...
public class FloorFiveLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorFiveCount > floorTwoCount & floorFiveCount > floorThreeCount & floorFiveCount > floorFourCount & floorFiveCount > floorOneCount & floorFiveCount > floorSixCount & floorFiveCount > floorSevenCount & floorFiveCount > floorEightCount)
        {
            LightOn();
        }
        else
