...
public class FloorThreeLight : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (floorThreeCount > floorTwoCount & floorThreeCount > floorOneCount & floorThreeCount > floorFourCount & floorThreeCount > floorFiveCount & floorThreeCount > floorSixCount & floorThreeCount > floorSevenCount & floorThreeCount > floorEightCount)
        {
            LightOn();
        }
        else
