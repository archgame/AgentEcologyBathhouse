...
public class whirligig : Conveyance
{
    public GameObject RCars;
    ...
    public override void SetDestination()
    {
        ...
        for (int i = 0; i < RCars.transform.childCount; i++)
        {
            _cars.Add(RCars.transform.GetChild(i).gameObject, i);
            _positions.Add(RCars.transform.GetChild(i).transform.position);
            _carRiders.Add(RCars.transform.GetChild(i).gameObject, null);
        }
